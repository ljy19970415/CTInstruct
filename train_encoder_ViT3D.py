from trainer.trainer_ablation_VIT3D import trainer_ablation
from datamanager.datamanager_VIT3D import data_Manager
import torch
import warnings
...
import deepspeed
from deepspeed.comm import get_rank, get_world_size

from model.encoder_ablation_VIT3D import Encoder_ablation
import os
import torch.distributed as dist

training_config_path = "config/train_ablation_VIT3D.yaml"
...
model_engine, optimizer, _, _ = deepspeed.initialize(model=model, 
                                            config_params=training_config["deepspeed_config"])
...
data_manager=data_Manager(task_names=training_config["task_list"],
